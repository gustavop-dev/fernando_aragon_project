...
```bash
source /home/ryzepeck/webapps/fernando_aragon_project/backend/venv/bin/activate && python /home/ryzepeck/webapps/fernando_aragon_project/backend/manage.py shell -c "
