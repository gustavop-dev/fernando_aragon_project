...
description: "Frontend unit test coverage strategy — analyze Vitest coverage reports and implement tests to reach 100% coverage across React components, hooks, and services."
---
